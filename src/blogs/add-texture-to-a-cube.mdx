...
It took me a while to understand how to add a texture to a cube in ThreeJS. This was due to a rookie mistake on my part and one I will highlight now for you so that you don't have to go through the hours of needless debugging until you realise that you haven't used the node properly.

Our finished piece can be viewed here: [A cube with texture](https://codesandbox.io/s/a-cube-with-texture-fzsj5)

I was going to assume that you have your canvas added and your css resets setup but I know how it is to google something and fine information missing, so let's just cover basic setup real quick.
...
We need to do this as our Canvas will be our main child element and it will take up 100% of its parents width and height. We reset the margina dn padding because we are good devs. If we were just adding our canvas to regular jsx markup then we would want to make sure that the parent element to our canvas has a fixed width and height.
