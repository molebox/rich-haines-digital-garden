...
tags: [programming thoughts, page transitions, SPA]
pin: false
---
...
If anyone is interested in this or following its progress the repo is at [space-exploration](https://github.com/molebox/space-exploration)
